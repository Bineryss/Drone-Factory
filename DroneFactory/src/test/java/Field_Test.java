...
//        ResourceManagement.loadEnergy(500);
//        int resource = 800;
//        ResourceManagement.addResources(resource);
...
//
//    @Test
//    public void droneFactoryFieldTest() {
//        DroneFactoryField dff = new DroneFactoryField(new DroneFactory());
//        dff.addBulding(new DroneFactory(), new DefaultDrone(), 1);
//
//        while (true) {
//
//        }
...
//        FieldManager.addBuilding(new Extractor(),1,1);
//
//
